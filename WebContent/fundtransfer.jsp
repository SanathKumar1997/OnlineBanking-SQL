...
<div class=" w3-card-4" style="width:80%;margin-left:10%;" >
  ...
  <div class="w3-row-padding w3-center" style="margin-top:64px">
    <div class="w3-quarter">
      <i class=" w3-xxlarge w3-margin-top fa fa-heart aria-hidden= w3-margin-bottom  w3-center"></i>
      <p class="">24X7 Care</p>
    ...
    <div class="w3-quarter">
      <i class= "w3-xxlarge w3-margin-top fa fa-shield aria-hidden= w3-margin-bottom "></i>
      <p class=""> Trust</p>
      <p>Your money is yours! All refunds come with no question asked guarantee.</p>
    </div>
    <div class="w3-quarter">
      <i class=" w3-xxlarge w3-margin-top fa fa-certificate aria-hidden= w3-margin-bottom"></i>
    ...
    <div class="w3-quarter">
      <i class=" w3-xxlarge w3-margin-top fa fa-thumbs-up aria-hidden= w3-margin-bottom w3-large"></i>
